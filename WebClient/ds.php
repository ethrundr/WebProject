...
<body>
  ...
  <table width="30%" border="1" cellpadding="0" cellspacing="1" bordercolor="#0099CC">
    <td>
...
?>
  ...
  <form name="rekapDailyStock" action="ds-det.php" method="post" target="_blank">
    ...
    <table width="36%" border="1"  bordercolor="#0033cc" align="center" cellspacing="1" bgcolor="#cccccc">
      <tr> 
